...
<link href="${basePath}/wx/css/style.css" rel="stylesheet" type="text/css" />
<script src="${basePath}/wx/js/jquery-1.7.2.js" type="text/javascript"></script>
<link href="${basePath}/wx/css/style_1.css" rel="stylesheet" type="text/css" />
...
<script src="${basePath}/wx/js/editor_config.js" type="text/javascript"></script>
<script src="${basePath}/wx/js/editor_all_min.js" type="text/javascript"></script>	
<script src="${basePath}/wx/js/O2String.js"	type="text/javascript"></script>
<script src="${basePath}/wx/js/JScriptImg.js" type="text/javascript"></script>		 
<script src="${basePath}/wx/js/ajaxfileupload.js" type="text/javascript"></script>
	<script type="text/javascript">
		...
		function ajaxFileUpload(_file,n) {
            ...
            (
                {
                	url: '${basePath}/${backPath}/wxImageText/ajaxUploadFile', //用于文件上传的服务器端请求地址
						...
						<div class="msg-item-wrapper">
							<div style="background:#ffefaf"
								...
								<div class="cover">
									...
									<#if (wm.picUrl)?? && wm.picUrl!='' >
										<img id="img_0" class="i-img" src="${basePath}${(wm.picUrl)!''}" onload="ImgMiddle(this,440,160)" />
									</#if>
								</div>
						...
						<div class="span7">
							<div class="msg-editer-wrapper">
								...
								<div id="val_item">
									...
									<div class="control-group">
										<div class="controls">
											<input id="save-btn" value="保存" class="greenbtn100" type="submit" style="background:#0088cc;border: 1px solid #0088cc"/>&nbsp;&nbsp;
											<input id="save-btn" value="返回" class="greenbtn100" type="button" style="background:#0088cc;border: 1px solid #0088cc" onclick="window.location.href='${basePath}${backPath}/wxImageText/weixin_material_list'"/>
										</div>
									</div>
									</form>
								</div>
