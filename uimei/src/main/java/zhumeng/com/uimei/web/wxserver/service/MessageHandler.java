...
public class MessageHandler {
	 ...
	 * @throws Exception 
	 */
	public String dealText(String content,String fromUserName,String toUserName,Long wxAppId) throws Exception{
		// 查询响应表 并 返回 xml 格式 字符串
	 ...
	 * @throws Exception 
	 */
	public String dealMenuClick(String eventKey,String fromUserName,String toUserName,Long wxAppId) throws Exception{
		// 查询响应表 并 返回 xml 格式 字符串
	 ...
	 * @throws Exception 
	 */
	public String dealDefault(String fromUserName, String toUserName, Long wxAppId) throws Exception {
		// 查询响应表 并 返回 xml 格式 字符串
