...
public class MenuConstUtil {
	   ...
	   static{
		   map.put("1", "zhumeng.com.uimei.web.wxserver.entity.menu.UrlMenu");//view
		   map.put("2", "zhumeng.com.uimei.web.wxserver.entity.menu.ClickMenu");//事件
		   map.put("3", "zhumeng.com.uimei.web.wxserver.entity.menu.ScancodeMenu");//扫码（显示结果）或者跳转链接
		   map.put("4", "zhumeng.com.uimei.web.wxserver.entity.menu.XcxMenu");//跳转小程序
		   map.put("5", "zhumeng.com.uimei.web.wxserver.entity.menu.ScancodeWaitmsg");//扫码，有提示框，可以接受开发者推送的消息
	   }
	   //根据数据存储菜单对象获取微信菜单
