...
//
//import com.gxnnbsd.charger.wx.service.WechatService;
//import com.gxnnbsd.charger.wx.util.SignUtil;
//import com.gxnnbsd.modules.business.charger.service.APIService;
...
//
////	    public String token="charger";//这个需要配成统一的token
//	    
...
//	        TWxApp wxApp = apiService.getWxApp(request);	        
//	        try {
//	            if (isGet&&wxApp!=null) {
...
//	                if (SignUtil.checkSignature(wxApp.getToken(), signature, timestamp, nonce)) {  
