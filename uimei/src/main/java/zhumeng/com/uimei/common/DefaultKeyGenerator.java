...
public class DefaultKeyGenerator implements KeyGenerator {
	...
	public final static Logger log = LoggerFactory.getLogger(DefaultKeyGenerator.class);
	 /**
     * 时间偏移量
     */
...
//    	log.error(defaultKeyGenerator.generateKey().toString());
//    	log.error(defaultKeyGenerator.generateKey().longValue()+"");
//    }
