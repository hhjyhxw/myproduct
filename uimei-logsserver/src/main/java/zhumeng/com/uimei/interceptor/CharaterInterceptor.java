...
//         }
	...
	private HttpServletRequest getHttpServletRequestProxyBiCglib(HttpServletRequest request) {
		return  (HttpServletRequest) new ServletRequestCglibProxy().getProxy(request.getClass());
	}
}
